...
def train_model():
    ...
    listrik = np.random.choice(watt_pilihan, jumlah_data)
    lokasi_pilihan = ['Pusat', 'Pinggir']
    lokasi = np.random.choice(lokasi_pilihan, jumlah_data)

    harga = (luas * 3000000) + (kamar * 20000000) + (listrik * 50000) + \
            (np.where(lokasi == 'Pusat', 200000000, 50000000))
